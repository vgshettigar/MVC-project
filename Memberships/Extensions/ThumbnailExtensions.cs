...
namespace Memberships.Extensions
{
    ...
    {
        private static async Task<List<int>> GetSubscriptionsIdsAsync(
            string userId = null, ApplicationDbContext db = null)
        {
            try
            {
                ...
                return await (from us in db.UserSubscriptions
                              ...
                              select us.UserSubscriptionId).ToListAsync();
            }
            catch { }
            return new List<int>();
        }
            ...
            this List<ThumbnailModel> thumbnails, string UserId=null, ApplicationDbContext db=null)
        {
            try
            {
                ...
                var subscriptionIds = await GetSubscriptionsIdsAsync(UserId, db);
