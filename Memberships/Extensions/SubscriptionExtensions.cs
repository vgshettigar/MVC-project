...
namespace Memberships.Extensions
{
    ...
    {
        public static async Task<int> GetSubscriptionByRegCode(
        ...
        public static async Task Register(this IDbSet<UserSubscription> userSubscription, int subscriptionId, string userId)
        {
            try
            {
                ...
                var exist = await Task.Run(() => userSubscription.CountAsync(
                    s => s.UserSubscriptionId.Equals(subscriptionId) && s.UserId.Equals(userId))) > 0;
            ...
            string userId, string code)
        {
            try
            {
                ...
                var id = await db.Subscriptions.GetSubscriptionByRegCode(code);
